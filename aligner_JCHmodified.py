...
class Aligner(object):
    ...
    def score(self, sequence_1, sequence_2, offset, scoring_maps=None, current_max=None):
        ...
        # =============================================================================
        '''
        on the contrary, current_max is not used in this function
        '''
        # =============================================================================
        ...
        # =============================================================================
        '''
        num_gaps is basically the sum of positions where sequences don't overlap
        ex:
        TTTTTTTT-----
        -----TTTGATAC
        num_gaps = 10
        ...
        It would be better if it was just the number of blank positions to the left of the forward read and 
        the number of blank positions to the right of the reverse read
        '''
        # =============================================================================
    ...
    def align(self, sequence_1, sequence_2, min_overlap=-1, max_overlap=-1, unidirectional=False, reverse=False, scoring_ranges=None):
        ...
        # =============================================================================
        '''
        sequence_1=reference
        sequence_2=read

        runs through different read offsets and scores the alignment
        returns the best scoring "offset" with it's associated score
        uses the overlap(), score(), and scoring_map() functions
        '''
        # =============================================================================
        ...
        for offset in offset_range:
            ...
            # =============================================================================
            # skips offset if it doesn't meet min/max overlap conditions
            # =============================================================================
